  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="入驻时间">
        <el-date-picker v-model="teacher.joinDate" value-format="yyyy-MM-dd"></el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="讲师头衔">
        <el-select v-model="teacher.level">
          ...
          <el-option :value="0" label="首席讲师"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="讲师资历">
        <el-input v-model="teacher.career" :rows="10" type="textarea"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 根据id更新记录
    updateData() {
      teacherApi.updataTeacher(this.teacher).then(response => {
        this.$message({
          type: 'success',
          message: response.message
        })
